...
def Define_type_authentication(zap, parameter_types_found, BASE_URL_LOGIN, request_body):
    ...
    for params in session_parameters:
        ...
        if name in keywords.password_field_identifiers and param_type in keywords.parameters_types:
